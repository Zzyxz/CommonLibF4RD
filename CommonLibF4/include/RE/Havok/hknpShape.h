...
namespace RE
{
	...
	public:
		...
		[[nodiscard]] std::uint32_t GetMaterialID(std::uint32_t a_shapeKey = 0) const
		{
			using func_t = std::uint32_t(const hknpShape*, std::uint32_t);
			static REL::Relocation<func_t> func{ REL::ID(1349330, 2278083) };
			return func(this, a_shapeKey);
		}
