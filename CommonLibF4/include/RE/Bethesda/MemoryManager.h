...
namespace RE
{
	...
	public:
		...
		void* Allocate(std::size_t a_size, std::size_t a_alignment)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1085394, 2267983) };
		...
		void Deallocate(void* a_mem)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(923307, 2267984) };
	...
	public:
		...
		private:
			AutoScrapBuffer* Ctor()
			{
				...
				REL::Relocation<func_t> func{ REL::ID(1571567, 2267865) };
				return func(this);
			}
			...
			void Dtor()
			{
				...
				REL::Relocation<func_t> func{ REL::ID(68625, 2267867) };
				return func(this);
			}
		};
		...
		[[nodiscard]] static MemoryManager& GetSingleton()
		{
			...
			const REL::Relocation<func_t> func{ REL::ID(343176, 4471522) };
			return func();
		}
		...
		[[nodiscard]] void* Allocate(std::size_t a_size, std::uint32_t a_alignment, bool a_alignmentRequired)
		{
			...
			const REL::Relocation<func_t> func{ REL::ID(652767, 2267872) };
		...
		void Deallocate(void* a_mem, bool a_alignmentRequired)
		{
			...
			const REL::Relocation<func_t> func{ REL::ID(1582181, 2267874) };
		...
		[[nodiscard]] ScrapHeap* GetThreadScrapHeap()
		{
			...
			const REL::Relocation<func_t> func{ REL::ID(1495205, 2267850) };
			return func(this);
		}
		...
		[[nodiscard]] void* Reallocate(void* a_oldMem, std::size_t a_newSize, std::uint32_t a_alignment, bool a_alignmentRequired)
		{
			...
			const REL::Relocation<func_t> func{ REL::ID(1502917, 2267873) };
		...
		void RegisterMemoryManager()
		{
			...
			const REL::Relocation<func_t> func{ REL::ID(453212, 2228356) };
			return func(this);
		}
