...
namespace RE
{
	...
	public:
		...
		{
			REL::Relocation<PlayerControls**> singleton{ REL::ID(544871, 4799306) };
			return *singleton;
		}
		...
		bool CanPerformAction(DEFAULT_OBJECT a_action)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(565925, 2234795) };
		...
		bool DoAction(DEFAULT_OBJECT a_action, ActionInput::ACTIONPRIORITY a_priority)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(818081, 2234796) };
	...
	private:
		void DoRegisterHandler(PlayerInputHandler* a_handler, bool a_isHeldStateHandler)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(177801, 2234822) };
