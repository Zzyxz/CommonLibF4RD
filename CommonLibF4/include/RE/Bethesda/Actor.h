...
namespace RE
{
	...
	public:
		...
		void SetWarnedActor(ActorHandle a_actor)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1153828, 2235038) };
			...
			const IAIWorldLocation* a_area3)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1060569, 2235039) };
		...
		void SetSuspiciousOf(PackageTarget* a_target)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(355735, 2235040) };
		...
		void SetWarnFromLoc(const IAIWorldLocation* a_location)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1312793, 2235041) };
	...
	public:
		...
		void SetupFireSounds(const Actor& a_actor, const BGSObjectInstanceT<TESObjectWEAP>& a_weapon)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1468462, 2232275) };
	...
	public:
		[[nodiscard]] TESAmmo* GetCurrentAmmo(BGSEquipIndex a_equipIndex) const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1154936, 2232300) };
			return func(this, a_equipIndex);
		}

		float GetHeadHeightOffset()
		{
			using func_t = decltype(&AIProcess::GetHeadHeightOffset);
			static REL::Relocation<func_t> func{ REL::ID(1060221, 2232336) };
			return func(this);
		}
		...
		void KnockExplosion(Actor* a_actor, const NiPoint3& a_location, float a_magnitude)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(533106, 2232384) };
		...
		void SetActorsDetectionEvent(Actor* a_actor, const NiPoint3& a_location, std::int32_t a_soundLevel, TESObjectREFR* a_refr)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1376336, 2231738) };
		...
		void SetCurrentAmmo(BGSEquipIndex a_equipIndex, TESAmmo* a_ammo)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(795983, 2232302) };
		...
		void SetEquippedItem(Actor* a, BGSObjectInstance& instance, const BGSEquipSlot* slot)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1200276, 2231627) };
			return func(this, a, instance, slot);
		}

		void SetupSpecialIdle(
			Actor& a_actor,
			DEFAULT_OBJECT a_defaultObject,
			TESIdleForm* a_idle,
			bool a_unk,
			TESObjectREFR* a_reference)
		{
			using func_t = decltype(&AIProcess::SetupSpecialIdle);
			REL::Relocation<func_t> func{ REL::ID(1446774, 2231704) };
			return func(this, a_actor, a_defaultObject, a_idle, a_unk, a_reference);
		}

		void PlayIdle(Actor* a_actor, std::uint32_t a_defaultObject, TESIdleForm* a_idle, bool a_unk = true, std::uint64_t a_reference = 0)
		{
			assert(a_actor);
			SetupSpecialIdle(
				*a_actor,
				static_cast<DEFAULT_OBJECT>(a_defaultObject),
				a_idle,
				a_unk,
				reinterpret_cast<TESObjectREFR*>(a_reference));
		}
		...
		bool RequestLoadAnimationsForWeaponChange(Actor& a_actor)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(666002, 2231758) };
			return func(this, a_actor);
		}
		...
		bool IsWeaponSubgraphFinishedLoading(Actor& a_actor)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(320183, 2231757) };
			return func(this, a_actor);
		}
		...
		void NotifyItemUnequipped(Actor* a_actor, const EquippedItem& a_item)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(398996, 2231631) };
		...
		[[nodiscard]] bool HasDefaultAnimationSet()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1291029, 2231756) };
			return func(this);
		}
		...
		void ClearSpokenList()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(393596, 2231792) };
			return func(this);
		}
		...
		void SetReanimateData(Actor* a_actor, MagicItem* a_item)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1166540, 2232035) };
			return func(this, a_actor, a_item);
		}
		...
		void ProcessGuardStartTravelToLocation(Actor* a_actor, GuardActorPackageData* a_data)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(171815, 2231660) };
		...
		void ProcessGuardInit(Actor* a_actor, GuardActorPackageData* a_data)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(525608, 2232125) };
			return func(this, a_actor, a_data);
		}
		...
		void ClearClothExtraDataCache(const Actor& a_actor)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(233747, 2232487) };
			return func(this, a_actor);
		}
	...
	public:
		...
		[[nodiscard]] bool IsTakingHealthDamageFromActiveEffect()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(999442, 2226397) };
			return func(this);
		}
		...
		[[nodiscard]] bool IsTakingRadDamageFromActiveEffect()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1079111, 2226398) };
			return func(this);
		}
	...
	public:
		...
		void AddPerk(BGSPerk* a_perk, std::uint8_t a_rank = 0)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(187096, 2230121) };
			return func(this, a_perk, a_rank);
		}

		void ApplySpell(SpellItem* a_spell, Actor* a_actor, TESBoundObject* a_object)
		{
			using func_t = decltype(&Actor::ApplySpell);
			REL::Relocation<func_t> func{ REL::ID(722232, 2231300) };
			return func(this, a_spell, a_actor, a_object);
		}
		...
		[[nodiscard]] BGSBodyPartData* GetBodyPartData()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1485196, 2229571) };
			return func(this);
		}
		...
		[[nodiscard]] BGSObjectInstance GetEquippedItem(BGSEquipIndex a_equipIndex) const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1318331, 2231089) };
			return func(this, a_equipIndex);
		}

		[[nodiscard]] BGSObjectInstance GetCurrentWeapon(BGSEquipIndex a_equipIndex)
		{
			using func_t = decltype(&Actor::GetCurrentWeapon);
			REL::Relocation<func_t> func{ REL::ID(1277201, 2231092) };
			return func(this, a_equipIndex);
		}
		...
		[[nodiscard]] bool GetHostileToActor(Actor* a_actor)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1148686, 2229968) };
			return func(this, a_actor);
		}
		...
		[[nodiscard]] std::int16_t GetLevel()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(661617, 2229734) };
			return func(this);
		}

		[[nodiscard]] TESNPC* GetNPC() const noexcept;

		[[nodiscard]] std::uint8_t GetPerkRank(const BGSPerk* a_perk)
		{
			using func_t = decltype(&Actor::GetPerkRank);
			REL::Relocation<func_t> func{ REL::ID(1368313, 2230125) };
			return func(this, a_perk);
		}

		[[nodiscard]] bool HasPerk(const BGSPerk* a_perk)
		{
			return GetPerkRank(a_perk) != 0;
		}

		[[nodiscard]] bool IsJumping()
		{
			using func_t = decltype(&Actor::IsJumping);
			REL::Relocation<func_t> func{ REL::ID(1041558, 2229640) };
			return func(this);
		}
		...
		void RemovePerk(BGSPerk* a_perk)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1316475, 2230122) };
			return func(this, a_perk);
		}
		...
		void Reset3D(bool a_reloadAll, std::uint32_t a_additionalFlags, bool a_queueReset, std::uint32_t a_excludeFlags)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(302888, 2229913) };
		...
		void RewardExperience(float a_amount, bool a_direct, TESObjectREFR* a_actionTarget, TESObjectREFR* a_killWeapon)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(262786, 2230428) };
		...
		int32_t RequestDetectionLevel(Actor* a_target, DETECTION_PRIORITY a_priority = DETECTION_PRIORITY::kNormal)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(943772, 2230190) };
			return func(this, a_target, a_priority);
		}

		int32_t RequestDetectionState(Actor* a_target, DETECTION_PRIORITY a_priority = DETECTION_PRIORITY::kNormal)
		{
			using func_t = decltype(&Actor::RequestDetectionState);
			REL::Relocation<func_t> func{ REL::ID(971167, 2230184) };
			return func(this, a_target, a_priority);
		}

		int32_t GetDetectionState(Actor* a_target)
		{
			using func_t = decltype(&Actor::GetDetectionState);
			REL::Relocation<func_t> func{ REL::ID(1237436, 2230183) };
			return func(this, a_target);
		}
		...
		void TrespassAlarm(TESObjectREFR* a_refr, TESForm* a_owner, std::int32_t a_crime)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1109888, 2229834) };
			return func(this, a_refr, a_owner, a_crime);
		}

		void HandleDefaultAnimationsSwitch()
		{
			using func_t = decltype(&Actor::HandleDefaultAnimationsSwitch);
			REL::Relocation<func_t> func{ REL::ID(1163130, 2229780) };
			return func(this);
		}

		void HandleDefaultAnimationSwitch()
		{
			HandleDefaultAnimationsSwitch();
		}

		void HandleItemEquip(bool bCullBone)
		{
			using func_t = decltype(&Actor::HandleItemEquip);
			REL::Relocation<func_t> func{ REL::ID(164912, 2229781) };
		...
		bool PerformAction(BGSAction* a_action, TESObjectREFR* a_target)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1057231, 2231177) };
		...
		void SetGunState(GUN_STATE gun_state, bool unk = true)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(977675, 2231175) };
		...
		void GetAimVector(NiPoint3& out)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(554863, 2230378) };
			return func(this, out);
		}

		[[nodiscard]] std::uint32_t GetCurrentCollisionGroup()
		{
			using func_t = decltype(&Actor::GetCurrentCollisionGroup);
			REL::Relocation<func_t> func{ REL::ID(410500, 2229993) };
			return func(this);
		}
		...
		CFilter GetCollisionFilter()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1474995, 2229991) };
			return func(this);
		}
		...
		bool GetCurrentFireLocation(BGSEquipIndex index, NiPoint3& out)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(663107, 2231167) };
		...
		float GetDesiredSpeed()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(106892, 2230410) };
			return func(this);
		}
		...
		NiAVObject* GetClosestBone(NiPoint3& a_position, const NiPoint3& a_direction)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1180004, 2230051) };
		...
		bhkCharacterController* Move(float a_deltaTime, const NiPoint3& a_deltaPosition, bool a_unk)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(737625, 2229934) };
		...
		void ExitCover()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(770035, 2231166) };
			return func(this);
		}
		...
		TESCombatStyle* GetCombatStyle()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1270929, 2231053) };
			return func(this);
		}
		...
		bool IsCrippled()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1238666, 2230998) };
			return func(this);
		}
		...
		bool IsFollowing()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(629579, 2230013) };
			return func(this);
		}
		...
		bool IsPathValid()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1522194, 2230273) };
			return func(this);
		}
		...
		bool IsPathing()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(989661, 2230276) };
			return func(this);
		}
		...
		bool IsPathingComplete()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(817283, 2230274) };
			return func(this);
		}
		...
		bool IsQuadruped()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1552322, 2229614) };
			return func(this);
		}

		bool StartCombat(Actor* a_actor, Actor* a_target)
		{
			using func_t = decltype(&Actor::StartCombat);
			REL::Relocation<func_t> func{ REL::ID(765218, 2231078) };
			return func(this, a_actor, a_target);
		}

		bool StarCombat(Actor* a_actor, Actor* a_target)
		{
			return StartCombat(a_actor, a_target);
		}
	...
	public:
		...
		{
			REL::Relocation<ActorEquipManager**> singleton{ REL::ID(1174340, 4798287) };
			return *singleton;
		}
			...
			bool a_locked)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(988029, 2231392) };
			...
			const BGSEquipSlot* a_slotBeingReplaced)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1292493, 2231395) };
			...
			bool a_arg6)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(332489, 2231402) };
