...
namespace RE
{
	...
	public:
		...
		bool SetGraphVariableBool(const BSFixedString& a_variable, bool a_var)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1437197, 2214543) };
		...
		bool SetGraphVariableFloat(const BSFixedString& a_variable, float a_var)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(27400, 2214545) };
			return func(this, a_variable, a_var);
		};
		...
		bool SetGraphVariableInt(const BSFixedString& a_variable, int a_var)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(732926, 2214544) };
			return func(this, a_variable, a_var);
		};
		...
		bool RevertAnimationGraphManager(bool unk = true)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(41382, 2214541) };
	...
	private:
		BGSObjectInstance* ctor(TESForm* a_object, TBO_InstanceData* a_instanceData)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1095748, 2197563) };
	...
	public:
			...
			bool a_alwaysContinue = false)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1354005, 2194179) };
	...
	private:
		void ctor(const TESContainer* a_container, std::uint32_t* a_owner)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(845050, 2194153) };
	...
	private:
		void Dtor()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(765242, 2194330) };
			return func(this);
		}
	};
	...
	public:
		void RemoveBipedAmmo()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(809712, 2194359) };
			return func(this);
		}
	...
	public:
		[[nodiscard]] LOCK_LEVEL GetLockLevel(TESObjectREFR* a_owner)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(782953, 2191018) };
		...
		void SetLocked(bool a_locked)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(157617, 2191020) };
	...
	public:
		...
		bool ActivateRef(TESObjectREFR* a_actionRef, TESBoundObject* a_objectToGet, std::int32_t a_count, bool a_defaultProcessingOnly, bool a_fromScript, bool a_looping)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(753531, 2201147) };
		...
		void AddInventoryItem(TESBoundObject* a_object, BSTSmartPointer<ExtraDataList> a_extra, std::uint32_t a_count, TESObjectREFR* a_oldContainer, const INSTANCE_FILTER* a_filter, TESObjectREFR* a_overrideRef)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(78185, 2200949) };
		...
		void AddKeyword(BGSKeyword* kwd)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(640674, 2200860) };
		...
		void AddLockChange()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1578706, 2200731) };
			return func(this);
		}
		...
		void Enable(bool a_resetInventory)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1396707, 2201150) };
		...
		[[nodiscard]] BGSLocation* GetCurrentLocation() const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1135470, 2201163) };
			return func(this);
		}
		...
		[[nodiscard]] TESWorldSpace* GetWorldSpace() const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(576133, 2201167) };
			return func(this);
		}
		...
		uint32_t GetEquipIndex(BGSEquipSlot a1)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(792417, 2200981) };
			return func(this, a1);
		}
		...
		float GetDistance(TESObjectREFR* a1, bool a2, bool a3)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(268887, 2201174) };
		...
		[[nodiscard]] TESForm* GetOwner()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1323437, 2202616) };
			return func(this);
		}
		...
		[[nodiscard]] std::int64_t GetGoldAmount()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(564356, 2200923) };
			return func(this);
		}
		...
		[[nodiscard]] ObjectRefHandle GetHandle()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1573130, 2201196) };
			return func(this);
		}
		...
		[[nodiscard]] std::uint32_t GetInventoryObjectCount(const TESBoundObject* a_object)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(333415, 2200939) };
		...
		[[nodiscard]] TESObjectREFR* GetLinkedRef(BGSKeyword* a_keyword)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(897287, 2202683) };
		...
		[[nodiscard]] REFR_LOCK* GetLock()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(930785, 2202648) };
			return func(this);
		}
		...
		[[nodiscard]] float GetWeightInContainer()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1377567, 2201001) };
			return func(this);
		}
		...
		[[nodiscard]] bool IsCrimeToActivate()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(836011, 2201180) };
			return func(this);
		}
		...
		[[nodiscard]] float GetRelevantWaterHeight()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(315318, 2201189) };
			return func(this);
		}
		...
		void MarkAsDeleted()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(192661, 2201156) };
			return func(this);
		}
		...
		void MoveRefToNewSpace(TESObjectCELL* a_interior, TESWorldSpace* a_world)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(629658, 2201149) };
		...
		void RemoveKeyword(BGSKeyword* kwd)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(281170, 2200861) };
			return func(this, kwd);
		}
		...
		void SetAngleOnReference(const NiPoint3& a_point)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1049748, 2201134) };
		...
		void SetLinkedRef(Actor* a_actor, BGSKeyword* a_keyword)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(192840, 2202684) };
		...
		void SetLocationOnReference(const NiPoint3& a_point)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1101832, 2201138) };
			return func(this, a_point);
		}
		...
		void SetWantsDelete(bool a_delete)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(761346, 2201199) };
		...
		void RebuildBendableSpline(bool rebuildCollision, NiAVObject* target)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(340319, 2201119) };
		...
		bool GetItemCount(uint32_t& count, TESForm* item, bool countComponent)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(635042, 2200996) };
		...
		void UpdateReference3D()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1568075, 2201071) };
			return func(this);
		}
		...
		void GetObjectCenter(NiPoint3& center)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(777738, 2201092) };
		...
		void SetScale(float scale)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(817930, 2200893) };
		...
		void UpdateDynamicNavmesh(bool a_active)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1518094, 2201206) };
