...
namespace RE
{
	...
	public:
		...
		{
			REL::Relocation<VATS**> singleton{ REL::ID(570121, 4797733) };
			return *singleton;
		}

		float GetPlayerDamageTakenMult() {
			using func_t = decltype(&VATS::GetPlayerDamageTakenMult);
			REL::Relocation<func_t> func{ REL::ID(971798, 2237183) };
			return func(this);
		}
