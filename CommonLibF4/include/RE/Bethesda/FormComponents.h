...
namespace RE
{
	...
	public:
		...
		void SetParentGroupNumber(BGSKeyword* keyword, uint32_t i)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1412266, 2189125) };
	...
	public:
		...
		[[nodiscard]] stl::enumeration<RE::BIPED_MODEL::BipedObjectSlot, std::uint32_t> GetFilledSlots() const noexcept { return bipedModelData.bipedObjectSlots; }
	...
	public:
		...
		void AddKeyword(BGSKeyword* a_keyword)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(762999, 2192766) };
		...
		void RemoveKeyword(BGSKeyword* kwd)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(921694, 2192767) };
	...
	public:
		...
		void AllocatePerkRankArray(std::uint32_t a_count)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(888419, 2192837) };
		...
		void ClearPerks(bool a_removeFormUser)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1247917, 2192836) };
	...
	public:
		...
		bool AddObjectNative(TESBoundObject* a_object, std::int32_t a_count, ContainerItemExtra* a_extra = nullptr)
		{
			if (!a_object || a_count == 0) {
				return false;
			}
			using func_t = ContainerObject* (*)(TESContainer*, TESBoundObject*, std::int32_t, ContainerItemExtra*);
			static REL::Relocation<func_t> func{ REL::ID(557305, 2192999) };
			return func(this, a_object, a_count, a_extra) != nullptr;
		}

		static bool ContainerCanHoldType(ENUM_FORM_ID a_formType)
		{
			using func_t = bool (*)(ENUM_FORM_ID);
			static REL::Relocation<func_t> func{ REL::ID(633812, 2193007) };
			return func(a_formType);
		}
	...
	public:
		void GetDescription(BSStringT<char>& a_out, const TESForm* a_form) const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(523613, 2193019) };
		...
		[[nodiscard]] BGSLocalizedStrings::ScrapStringBuffer GetText(TESFile& a_file) const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(472297, 2194238) };
	...
	public:
		...
		{
			REL::Relocation<BSTHashMap<const TESForm*, BGSLocalizedString>*> sparseFullNameMap{ REL::ID(226372, 2661402), -0x8 };
		...
		void SetFullNameENG(const char* a_fullName)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(791135, 2205221) };
	...
	public:
		...
		[[nodiscard]] static std::uint32_t GetFormHealth(const TESForm* a_form, const TBO_InstanceData* a_data)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1515099, 2193227) };
	...
	public:
		...
		LEVELED_OBJECT* AddLeveledObject(uint16_t a_level, uint16_t a_count, int8_t a_chanceNone, TESForm* a_item, ContainerItemExtra* a_itemExtra)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1163308, 2193258) };
		...
		bool GetUseAll()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(233875, 2193253) };
			return func(this);
		}
		...
		void RemoveAllScriptAddedLeveledObjects()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1500052, 2193268) };
			return func(this);
		}
	...
	public:
		...
		bool AddSpell(TESForm* a_spell)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1312083, 2193395) };
	...
	public:
		...
		[[nodiscard]] static std::uint32_t GetFormValue(const TESForm* a_form, const TBO_InstanceData* a_data)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(885783, 2193435) };
			return func(a_form, a_data);
		}
	...
	public:
		...
		[[nodiscard]] static float GetFormWeight(const TESForm* a_form, const TBO_InstanceData* a_data)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1321341, 2193446) };
			return func(a_form, a_data);
		}
