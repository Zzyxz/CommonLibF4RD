...
namespace RE::BSResource::Archive2
{
	...
	public:
		...
		ErrorCode DoOpen() override  // 01
		{
			...
			REL::Relocation<func_t> func{ REL::ID(762048, 2269280) };
			return func(this);
		}
		...
		void DoClose() override  // 02
		{
			...
			REL::Relocation<func_t> func{ REL::ID(109149, 2269285) };
			return func(this);
		}
		...
		std::uint64_t DoGetKey() const override  // 03
		{
			...
			REL::Relocation<func_t> func{ REL::ID(772817, 2269288) };
			return func(this);
		}
		...
		void DoClone(BSTSmartPointer<Stream>& a_result) const override  // 05
		{
			...
			REL::Relocation<func_t> func{ REL::ID(855081, 2269279) };
		...
		ErrorCode DoRead(void* a_buffer, std::uint64_t a_bytes, std::uint64_t& a_read) const override  // 06
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1359347, 2269281) };
		...
		ErrorCode DoSeek(std::int64_t a_offset, SeekMode a_whence, std::uint64_t& a_pos) const override  // 09
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1000164, 2269282) };
		...
		ErrorCode DoPrefetchAll(std::uint32_t a_priority) const override  // 0E
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1518821, 2269284) };
		...
		ErrorCode DoCreateAsync(BSTSmartPointer<AsyncStream>& a_result) const override  // 10
		{
			...
			REL::Relocation<func_t> func{ REL::ID(893405, 2269287) };
			return func(this, a_result);
		}
	...
	public:
		...
		ErrorCode DoOpen() override  // 01
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1401160, 2269387) };
			return func(this);
		}
		...
		void DoClose() override  // 02
		{
			...
			REL::Relocation<func_t> func{ REL::ID(883012, 2269380) };
			return func(this);
		}
			...
			BSTSmartPointer<AsyncStream>& a_result) const override  // 05
		{
			...
			REL::Relocation<func_t> func{ REL::ID(803750, 2269379) };
			return func(this, a_result);
		}
			...
			std::uint64_t a_offset) const override  // 06
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1215072, 2269395) };
			...
			std::uint64_t a_offset) const override  // 07
		{
			...
			REL::Relocation<func_t> func{ REL::ID(603387, 2269394) };
			return func(this, a_buffer, a_bytes, a_offset);
		}
			...
			bool a_block) override  // 0B
		{
			...
			REL::Relocation<func_t> func{ REL::ID(244066, 2269399) };
