...
namespace RE
{
	...
	{
		REL::Relocation<DEFAULT_OBJECT_DATA(*)[394]> data{ REL::ID(838886, 838886) };
		return { *data };
	}
	...
	public:
		...
		{
			if (REL::Module::get().version() < REL::Version{ 1, 11, 0, 0 }) {
				using func_t = decltype(&BGSDefaultObjectManager::GetSingleton);
				REL::Relocation<func_t> func{ REL::ID(484974, REL::ID::INVALID_ID) };
				return func();
			}

			REL::Relocation<BGSDefaultObjectManager*> singleton{ REL::ID(REL::ID::INVALID_ID, 4796209) };
		...
		[[nodiscard]] TESForm* GetDefaultObject(DEFAULT_OBJECT a_obj) const noexcept
		{
			...
			REL::Relocation<func_t> func{ REL::ID(819830, 2192850) };
			return func(a_obj);
		}
	...
	public:
		...
		{
			REL::Relocation<BSTArray<BGSDefaultObject*>**> singleton{ REL::ID(561749, 4797762) };
			return *singleton;
		}
	...
	private:
		BGSDefaultObject* ctor(const char* a_name, ENUM_FORM_ID a_formType, const char* a_description)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1144014, 2197003) };
