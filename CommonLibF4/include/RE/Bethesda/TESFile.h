...
namespace RE
{
	...
	public:
		...
		[[nodiscard]] bool CloseTES(bool a_forceClose)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(766555, 2192491) };
		...
		[[nodiscard]] bool GetChunkData(void* a_data, std::uint32_t a_maxSize)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(188910, 2192538) };
		...
		[[nodiscard]] std::uint32_t GetTESChunk()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(641361, 2192536) };
			return func(this);
		}
		...
		[[nodiscard]] bool NextChunk()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1252764, 2192537) };
			return func(this);
		}
		...
		[[nodiscard]] bool NextForm(bool a_skipIgnored)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(644374, 2192527) };
		...
		[[nodiscard]] bool NextGroup()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(339855, 2192522) };
			return func(this);
		}
		...
		[[nodiscard]] bool OpenTES(char* a_path, const char* a_filename, NiFile::OpenMode a_accessMode, bool a_lock)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(728465, 2192490) };
