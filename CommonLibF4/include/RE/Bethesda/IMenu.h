...
namespace RE
{
	...
	public:
		...
		{
			REL::Relocation<FlatScreenModel**> singleton{ REL::ID(847741, 4801718) };
			return *singleton;
		}
	...
	public:
		void UpdateDataModels()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1269653, 2220905) };
			return func(this);
		}
	};
	...
	public:
		...
		bool ShouldHandleEvent(const InputEvent* a_event) override  // 01
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1241790, 2287392) };
		...
		void HandleEvent(const ButtonEvent* a_event) override  // 08
		{
			if (menuObj.IsObject()) {
				...
				REL::Relocation<func_t> func{ REL::ID(1414130, 2287393) };
				return func(this, a_event);
			}
		}
		...
		virtual bool PassesRenderConditionText(MENU_RENDER_CONTEXT a_reason, const BSFixedString& a_customRendererName) const  // 07
		{
			...
			REL::Relocation<func_t> func{ REL::ID(937304, 2287379) };
		...
		void OnSetSafeRect()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(964859, 2287375) };
			return func(this);
		}
		...
		UI_MESSAGE_RESULTS ProcessScaleformEvent(Scaleform::GFx::Movie* a_movie, const IUIMessageData* a_data)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(150211, 2287395) };
		...
		void RefreshPlatform()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1071829, 2287374) };
			return func(this);
		}
	...
	public:
		...
		Scaleform::GFx::Value* AcquireFlashObjectByMemberName(const Scaleform::GFx::Value& a_flashObject, const char* a_relativePathToMember)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1172680, 2287014) };
		...
		Scaleform::GFx::Value* AcquireFlashObjectByPath(const Scaleform::GFx::Movie& a_parentMovie, const char* a_absolutePathToMember)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1065592, 2287015) };
	...
	public:
		...
		void RemoveChild(const BSGFxDisplayObject& a_child) const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1229383, 2287327) };
	...
	public:
		...
		virtual BSEventNotifyControl ProcessEvent(const ApplyColorUpdateEvent& a_event, BSTEventSource<ApplyColorUpdateEvent>* a_source) override  // 01
		{
			...
			REL::Relocation<func_t> func{ REL::ID(848563, 2287033) };
		...
		virtual void AppendShaderFXInfos(BSTArray<UIShaderFXInfo>& a_colorFXInfo, BSTArray<UIShaderFXInfo>& a_backgroundFXInfo)  // 02
		{
			...
			REL::Relocation<func_t> func{ REL::ID(544646, 2287021) };
		...
		void CreateAndSetFiltersToHUD(HUDColorTypes a_colorType, float a_scale = 1.0)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(876001, 2287027) };
		...
		void EnableShadedBackground(HUDColorTypes a_colorType, float a_scale = 1.0)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(278402, 2287022) };
			func(this, a_colorType, a_scale);
		}
	...
	public:
		...
		virtual void SetIsTopButtonBar(bool a_isTopButtonBar) override  // 08
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1367353, 2223204) };
		...
		virtual void OnMenuDisplayStateChanged() override  // 0A
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1274450, 2223205) };
			return func(this);
		}
		...
		virtual bool CacheShaderFXQuadsForRenderer_Impl() override  // 10
		{
			...
			REL::Relocation<func_t> func{ REL::ID(863029, 2223200) };
			return func(this);
		}
		...
		virtual void TransferCachedShaderFXQuadsForRenderer(const BSFixedString& a_rendererName) override  // 11
		{
			...
			REL::Relocation<func_t> func{ REL::ID(65166, 2223201) };
		...
		virtual void SetViewportRect(const NiRect<float>& a_viewportRect) override  // 12
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1554334, 2223202) };
		...
		virtual void AppendShaderFXInfos(BSTAlignedArray<UIShaderFXInfo>& a_colorFXInfos, BSTAlignedArray<UIShaderFXInfo>& a_backgroundFXInfos) const  // 13
		{
			...
			REL::Relocation<func_t> func{ REL::ID(583584, 2223203) };
		...
		void SetUpButtonBar(BSGFxShaderFXTarget& a_parentObject, const char* a_buttonBarPath, HUDColorTypes a_colorType)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(531584, 2223197) };
	...
	public:
		...
		static void ExecuteCommand(const char* a_command)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1061864, 2248537) };
			return func(a_command);
		}

		[[nodiscard]] static decltype(auto) GetCurrentPickIndex()
		{
			REL::Relocation<std::int32_t*> currentPickIndex{ REL::ID(1407033, 2701382) };
			return *currentPickIndex;
		}

		[[nodiscard]] static decltype(auto) GetPickRef()
		{
			REL::Relocation<ObjectRefHandle*> ref{ REL::ID(170742, 2701395) };
			return *ref;
		}

		[[nodiscard]] static decltype(auto) GetPickRefs()
		{
			REL::Relocation<BSTArray<ObjectRefHandle>*> pickRefs{ REL::ID(875116, 2701391) };
			return *pickRefs;
		}
		...
		void SetCurrentPickREFR(stl::not_null<ObjectRefHandle*> a_refr)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(79066, 2248551) };
	...
	public:
		...
		void CheckAndSetItemForPlacement()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1541862, 2224991) };
			return func(this);
		}
		...
		void UpdateButtonText()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1089189, 2224992) };
			return func(this);
		}
	...
	public:
		...
		BSEventNotifyControl ProcessEvent(const PipboyValueChangedEvent& a_event, BSTEventSource<PipboyValueChangedEvent>* a_source) override
		{
			...
			REL::Relocation<func_t> func{ REL::ID(893703, 2224270) };
			return func(this, a_event, a_source);
		}
	...
	public:
		...
		void UpdateData() override
		{
			...
			REL::Relocation<func_t> func{ REL::ID(332518, 2224261) };
			return func(this);
		}
	...
	public:
		...
		void UpdateData() override
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1426810, 2224256) };
			return func(this);
		}
	};
	...
	public:
		...
		void UpdateData() override
		{
			...
			REL::Relocation<func_t> func{ REL::ID(783380, 2224224) };
			return func(this);
		}
	};
	...
	public:
		...
		void UpdateData() override
		{
			...
			REL::Relocation<func_t> func{ REL::ID(762897, 2224143) };
			return func(this);
		}
	};
	...
	public:
		...
		void UpdateData() override
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1495929, 2224231) };
			return func(this);
		}
	};
	...
	public:
		...
		void UpdateData() override
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1370368, 2224273) };
			return func(this);
		}
	};
	...
	public:
		...
		void UpdateData() override
		{
			...
			REL::Relocation<func_t> func{ REL::ID(672256, 2224052) };
			return func(this);
		}
	};
	...
	public:
		...
		void UpdateData() override
		{
			...
			REL::Relocation<func_t> func{ REL::ID(92696, 2224074) };
			return func(this);
		}
	...
	public:
		...
		void UpdateData() override
		{
			...
			REL::Relocation<func_t> func{ REL::ID(713423, 2224242) };
			return func(this);
		}
	...
	public:
		...
		void UpdateData() override
		{
			...
			REL::Relocation<func_t> func{ REL::ID(426990, 2224248) };
			return func(this);
		}
	};
	...
	public:
		...
		public:
			...
			void IncrementSort()
			{
				...
				REL::Relocation<func_t> func{ REL::ID(1307263, 2222848) };
				return func(this);
			}
	...
	public:
		...
		void TakeAllItems()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1323703, 2248619) };
			return func(this);
		}
	...
	public:
		...
		void ClearTradingData()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1112285, 2222700) };
			return func(this);
		}
		...
		void CompleteTrade()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(379932, 2222701) };
			return func(this);
		}
		...
		[[nodiscard]] std::int64_t GetCapsOwedByPlayer()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(672405, 2222714) };
			return func(this);
		}
	...
	public:
		...
		void ShowMessage()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(442479, 2249469) };
			return func(this);
		}
	...
	public:
		...
		void BuildWeaponScrappingArray()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(646841, 2223077) };
			return func(this);
		}
		...
		[[nodiscard]] std::uint32_t GetSelectedIndex()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(776503, 2223022) };
			return func(this);
		}
		...
		void ShowConfirmMenu(ExamineConfirmMenu::InitData* a_data, ExamineConfirmMenu::ICallback* a_callback)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(443081, 2223081) };
	...
	public:
		...
		static void OpenLockpickingMenu(TESObjectREFR* a_lockedRef)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(129892, 2249263) };
