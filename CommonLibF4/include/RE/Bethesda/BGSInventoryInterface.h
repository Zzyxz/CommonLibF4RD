...
namespace RE
{
	...
	public:
		...
		{
			REL::Relocation<BGSInventoryInterface**> singleton{ REL::ID(501899, 4796586) };
			return *singleton;
		}
		...
		[[nodiscard]] const BGSInventoryItem* RequestInventoryItem(const std::uint32_t& a_handleID) const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1200959, 2194009) };
		...
		[[nodiscard]] bool ForceMergeStacks(const std::uint32_t& a_handleID)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1356509, 2194032) };
			return func(this, a_handleID);
		}
