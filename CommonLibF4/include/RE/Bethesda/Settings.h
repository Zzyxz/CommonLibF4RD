...
namespace RE
{
	...
	public:
		...
		[[nodiscard]] static void InitCollection()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(948832, 2188690) };
			return func();
		}

		[[nodiscard]] static GameSettingCollection* GetSingleton()
		{
			REL::Relocation<GameSettingCollection**> singleton{ REL::ID(8308, 4797590) };
			return *singleton;
		}
	};
	...
	public:
		...
		{
			REL::Relocation<INISettingCollection**> singleton{ REL::ID(791183, 2704108) };
			return *singleton;
		}
	...
	public:
		...
		{
			REL::Relocation<INIPrefSettingCollection**> singleton{ REL::ID(767844, 2703234) };
			return *singleton;
		}
	};
