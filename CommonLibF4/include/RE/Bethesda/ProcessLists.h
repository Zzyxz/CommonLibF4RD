...
namespace RE
{
	...
	public:
		...
		{
			REL::Relocation<ProcessLists**> singleton{ REL::ID(1569706, 4796160) };
			return *singleton;
		}
		...
		[[nodiscard]] bool AreHostileActorsNear(BSScrapArray<ActorHandle>* a_hostileActorArray)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1053584, 2234105) };
		...
		[[nodiscard]] bool IsActorTargetingREFinPackage(const TESObjectREFR* a_actor, PTYPE a_type, bool a_onlyHigh)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(559542, 2234033) };
		...
		[[nodiscard]] std::int16_t RequestHighestDetectionLevelAgainstActor(Actor* a_actor, std::uint32_t& a_LOSCount)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1036693, 2234111) };
		...
		void RunActorUpdate(Actor* a_actor, bool a_arg2, float a_delta)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(712994, 2234074) };
