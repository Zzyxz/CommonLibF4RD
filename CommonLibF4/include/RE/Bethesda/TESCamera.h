...
namespace RE
{
	...
	public:
		...
		{
			REL::Relocation<PlayerCamera**> singleton{ REL::ID(1171980, 4796065) };
			return *singleton;
		}
		...
		void SetState(TESCameraState* a_newstate) const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(858847, 2214742) };
		...
		void GetCameraPosition(NiPoint3& out, bool world) const
		{
			...
			static REL::Relocation<func_t> func{ REL::ID(1574794, 2248334) };
		...
		void SetCameraOverride(bool enable)
		{
			...
			static REL::Relocation<func_t> func{ REL::ID(1418633, 2248407) };
		...
		void SetSpecialCameraPosition(const NiPoint3& pos)
		{
			...
			static REL::Relocation<func_t> func{ REL::ID(345417, 2248363) };
