...
namespace RE
{
	...
	public:
		...
		void ApplyMods(BSTSmartPointer<TBO_InstanceData>& a_dest, const BGSObjectInstanceExtra* a_extra) const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(113585, 2198325) };
	...
	public:
		...
		void SetDefaultMod(RE::BGSMod::Attachment::Mod* a_mod)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1376431, 2198796) };
	...
	public:
		...
		static void RegisterWeaponFiredEvent(BSTEventSink<WeaponFiredEvent>* a_sink)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(528622, 2198914) };
			return func(a_sink);
		}
		...
		static void UnregisterWeaponFiredEvent(BSTEventSink<WeaponFiredEvent>* a_sink)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1405846, 2198915) };
			return func(a_sink);
		}
			...
			BGSEquipIndex a_equipIndex)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1578899, 2198917) };
		...
		[[nodiscard]] MELEE_ATTACK_SPEED GetMeleeAttackSpeed()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(817670, 2198957) };
			return func(this);
		}
		...
		[[nodiscard]] static const char* GetMeleeAttackSpeedLabel(MELEE_ATTACK_SPEED a_speed)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(178784, 2198959) };
			return func(a_speed);
		}
	...
	public:
		...
		[[nodiscard]] static bool GetReloadsWithAmmoRef(const TESAmmo* a_ammo)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1035622, 2197864) };
			return func(a_ammo);
		}
	...
	public:
		...
		[[nodiscard]] BGSSoundDescriptorForm* GetRicochetSound() const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(65526, 2197617) };
			return func(this);
		}
		...
		[[nodiscard]] static float GetRelaunchInterval(const BGSProjectile* a_projectile)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(504254, 2197618) };
		...
		[[nodiscard]] COL_LAYER GetCollisionLayer() const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1381569, 2197619) };
			return func(this);
		}
		...
		[[nodiscard]] bool CollidesWithSmallTransparentLayer() const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1115694, 2197620) };
			return func(this);
		}
