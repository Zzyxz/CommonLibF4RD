	...
	public:
		...
		private:
			void ctor(bool a_suppressMessages, bool a_suppressAudio)
			{
				...
				REL::Relocation<func_t> func{ REL::ID(1512872, 2233292) };
			...
			void dtor()
			{
				...
				REL::Relocation<func_t> func{ REL::ID(542100, 2233293) };
				return func(this);
			}
		};
		...
		{
			REL::Relocation<NiPointer<PlayerCharacter>*> singleton{ REL::ID(303410, 2698073) };
		...
		void RemoveLastUsedPowerArmor()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1488486, 2233024) };
			return func(this);
		}
		...
		void SelectPerk(std::uint32_t a_formID, std::int8_t a_rank = 0)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1397326, 2232926) };
		...
		void SetEscaping(bool a_flag, bool a_escaped)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(25528, 2233142) };
		...
		bool IsGodMode()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1032309, 2232986) };
			return func(this);
		}
		...
		bool IsHolotapePlaying(BGSNote* a_holotape)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(530826, 2233206) };
		...
		bool IsImmortal()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(500346, 2232988) };
			return func(this);
		}
		...
		bool IsPipboyLightOn()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(426550, 2233202) };
			return func(this);
		}
		...
		bool IsSneaking()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1173627, 2207655) };
			return func(this);
		}
		...
		void PauseHolotape(BGSNote* a_holotape)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1567456, 2233208) };
			return func(this, a_holotape);
		}
		...
		void PlayHolotape(BGSNote* a_holotape)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1581042, 2233207) };
			return func(this, a_holotape);
		}
		...
		void SetVATSCriticalCount(uint32_t a_critCount)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(327338, 2233219) };
		...
		void TogglePipBoyLight()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(520007, 2233201) };
			return func(this);
		}
