...
namespace RE
{
	...
	public:
		...
		[[nodiscard]] static ProjectileHandle Launch(const ProjectileLaunchData& a_data)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1452334, 2236958) };
			return func(a_data);
		}
		...
		void Kill()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1564187, 2236961) };
			func(this);
		}
		...
		void SetPosition(const NiPoint3& a_point)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1517016, 2237025) };
			func(this, a_point);
		}
		...
		void MoveHavok(bool a_activate)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1547227, 2718807) };
		...
		[[nodiscard]] bool GetFireNodePos(NiPoint3& a_position) const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(211403, 2237038) };
		...
		[[nodiscard]] COL_LAYER GetCollisionLayer() const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1027540, 2237045) };
			return func(this);
		}
		...
		void AimAtPoint(const NiPoint3& a_point)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1421932, 2237052) };
			func(this, a_point);
		}
		// members
	...
	public:
		...
		void SetVelocityDamping(float a_linearDamping, float a_angularDamping)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(971185, 2236777) };
