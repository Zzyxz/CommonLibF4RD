...
namespace RE
{
	...
	public:
		void Initialize()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1403529, 2284938) };
			return func(this);
		}
	...
	public:
		...
		{
			REL::Relocation<BSScaleformManager**> singleton{ REL::ID(106578, 4796889) };
			return *singleton;
		}
			...
			float a_backgroundAlpha = 0.0F)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1526234, 2287422) };
	...
	private:
		[[nodiscard]] bool GetMovieFilename(char const* a_menuName, BSStaticStringT<260>& a_filePath)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(1191277, 2287428) };
		...
		void InitMovieViewport(Scaleform::GFx::Movie& a_movie, const float a_dynamicWidthRatio, const float a_dynamicHeightRatio)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(206895, 4494254) };
